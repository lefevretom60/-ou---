...
int main()
{
...

	{
		...
		printf("\nVous avez choisis le Mode Un Joueur\n\n");
...

		{
...

			{
...

				{
					...
					printf("\nSuppert !!! Le nombre mystere est bien: %d et vous avez trouve en %d coups.\n\n", nombreMystere, nombreDeCoup);
...

	{
...

		{
...

			{
				...
				{
					printf("\nSuppert !!! Le nombre mystere est : %d et vous avez trouve en %d coups.\n\n", nombreMystere, nombreDeCoup);
				}
				nombreDeCoup++;
			}
			printf("Voulez-vous continuer la partie ?\n\n");
